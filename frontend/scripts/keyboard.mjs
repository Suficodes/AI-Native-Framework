...
for (const [route, expectHashPrefix] of [
  ...
  await page.goto(`http://localhost:3400/#${route}`,{waitUntil:'networkidle0'}); await wait(1200)
...
console.log('\n════ Focus visibility ════')
await page.goto('http://localhost:3400/#/agents',{waitUntil:'networkidle0'}); await wait(1000)
...
await page.goto('http://localhost:3400/#/organization',{waitUntil:'networkidle0'}); await wait(1600)
