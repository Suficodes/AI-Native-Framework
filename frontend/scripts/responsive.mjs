...
const ROUTES = ['/', '/organization', '/agents', '/value-realization', '/token-economics', '/observability', '/strategic-alignment', '/ai-playbook', '/administration', '/agent-constellation', '/capability-library']
