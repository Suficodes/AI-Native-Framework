...
const Icons = {
  ...
  versioncontrol: icon(<circle key="a" cx="6" cy="5" r="2.2" />, <circle key="b" cx="6" cy="19" r="2.2" />, <circle key="c" cx="18" cy="12" r="2.2" />, <path key="d" d="M6 7.2v9.6" />, <path key="e" d="M6 12h6a4 4 0 0 0 4-2" />),
...
export const CONTROL_TOWER_NAV = [
  ...
  { path: '/version-control', label: 'Version Control & GitHub', icon: Icons.versioncontrol },
